...
class CycleChartTableViewController: UIViewController,SuggestionsViewControllerDelegate, MKLocalSearchCompleterDelegate, UITextFieldDelegate  {
    ...
    @objc func getCycleChartButtonTapped() {
        ...
        geocoding(location: location) { latitude, longitude in
         ...
         //       print("chartCake: \(chartCake?.natal.sun.formatted ?? <#default value#>)")
                ...
                cycleChartVC.title = "\(selectedPlanetName!) Cycle Chart"
