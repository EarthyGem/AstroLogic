...
class HousesCustomTableViewCell2: UITableViewCell {
...
//
   ...
   //        tableCell.backgroundColor = .darkGray
           ...
           firstPlanetText.font = .systemFont(ofSize: 12)
           ...
           secondPlanetText.numberOfLines = 3
//           secondPlanetText.font = UIFont.boldSystemFont(ofSize: secondPlanetText.font.pointSize)
           ...
           secondAspectHeaderText.font = .systemFont(ofSize: 10)
          ...
          firstAspectHeaderText.text = "Power Urges"
           firstAspectHeaderText.font = .systemFont(ofSize: 10)
