...
class InteraspectsViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
     ...
     override func viewDidLayoutSubviews() {
        ...
        neptuneTableView.backgroundColor = .gray
         ...
         sunTableView.contentSize.height = CGFloat((synastry?.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!, by: Planet.sun.celestialObject).count)! * 90)


         moonTableView.contentSize.height = CGFloat((synastry?.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!, by: Planet.moon.celestialObject).count)! * 90)

         mercuryTableView.contentSize.height = CGFloat((synastry?.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!, by: Planet.mercury.celestialObject).count)! * 90)

         venusTableView.contentSize.height = CGFloat((synastry?.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!, by: Planet.venus.celestialObject).count)! * 90)

         marsTableView.contentSize.height = CGFloat((synastry?.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!, by: Planet.mars.celestialObject).count)! * 90)

         jupiterTableView.contentSize.height = CGFloat((synastry?.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!, by: Planet.jupiter.celestialObject).count)! * 90)

         saturnTableView.contentSize.height = CGFloat((synastry?.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!, by: Planet.saturn.celestialObject).count)! * 90)

         uranusTableView.contentSize.height = CGFloat((synastry?.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!, by: Planet.uranus.celestialObject).count)! * 90)

         neptuneTableView.contentSize.height = CGFloat((synastry?.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!, by: Planet.neptune.celestialObject).count)! * 90)

         plutoTableView.contentSize.height = CGFloat((synastry?.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!, by: Planet.pluto.celestialObject).count)! * 90)
...
extension InteraspectsViewController: UITableViewDataSource, UITableViewDelegate {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {


        if(tableView == sunTableView) {

            return (synastry?.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!, by: Planet.sun.celestialObject).count)!
    }
        else if(tableView == moonTableView){
            return (synastry?.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!, by: Planet.moon.celestialObject).count)!
        }


            else if(tableView == mercuryTableView){

                return (synastry?.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!, by: Planet.mercury.celestialObject).count)!
            }
            else if(tableView == venusTableView){

                return (synastry?.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!, by: Planet.venus.celestialObject).count)!
                }
        else if(tableView == marsTableView){

            return (synastry?.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!, by: Planet.mars.celestialObject).count)!
                    }
        else if(tableView == jupiterTableView){

            return (synastry?.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!, by: Planet.jupiter.celestialObject).count)!
                        }
        else if(tableView == saturnTableView){

            return (synastry?.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!, by: Planet.saturn.celestialObject).count)!
                            }
        else if(tableView == uranusTableView){

            return (synastry?.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!, by: Planet.uranus.celestialObject).count)!
                                }
        else if(tableView == neptuneTableView){

            return (synastry?.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!, by: Planet.neptune.celestialObject).count)!
                                    }
        else {

            return (synastry?.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!, by: Planet.pluto.celestialObject).count)!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if(tableView == sunTableView) {
            ...
            cell.configure(aspectingPlanet: "", secondPlanetImageImageName: "", firstSignTextText: "", secondSignTextText: "", secondPlanetTextText: synastry!.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!,by: Planet.sun.celestialObject)[indexPath.row].basicAspectString, firstPlanetTextText: "",firstAspectHeaderTextText: "",secondAspectHeaderTextText: " " )
...
//                    cell.configure(aspectingPlanet: "", secondPlanetImageImageName: MajorMoonAspects2()[indexPath.row], firstSignTextText: "", secondSignTextText: "", secondPlanetTextText: "", firstPlanetTextText: transitSunAspects[indexPath.row],firstAspectHeaderTextText: " ",secondAspectHeaderTextText: " " )
           ...
           return cell
            ...
            cell.configure(aspectingPlanet: "", secondPlanetImageImageName: "", firstSignTextText: "", secondSignTextText: "", secondPlanetTextText: synastry!.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!,by: Planet.moon.celestialObject)[indexPath.row].basicAspectString, firstPlanetTextText: "",firstAspectHeaderTextText: "",secondAspectHeaderTextText: " " )
           ...
           return cell
            ...
            cell.configure(aspectingPlanet: "", secondPlanetImageImageName: "", firstSignTextText: "", secondSignTextText: "", secondPlanetTextText: synastry!.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!,by: Planet.mercury.celestialObject)[indexPath.row].basicAspectString, firstPlanetTextText: "",firstAspectHeaderTextText: "",secondAspectHeaderTextText: " " )
           ...
           return cell
                ...
                cell.configure(aspectingPlanet: "", secondPlanetImageImageName: "", firstSignTextText: "", secondSignTextText: "", secondPlanetTextText: synastry!.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!,by: Planet.venus.celestialObject)[indexPath.row].basicAspectString, firstPlanetTextText: "",firstAspectHeaderTextText: "",secondAspectHeaderTextText: " " )
            ...
            cell.configure(aspectingPlanet: "", secondPlanetImageImageName: "", firstSignTextText: "", secondSignTextText: "", secondPlanetTextText: synastry!.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!,by: Planet.mars.celestialObject)[indexPath.row].basicAspectString, firstPlanetTextText: "",firstAspectHeaderTextText: "",secondAspectHeaderTextText: " " )
           ...
           return cell
            ...
            cell.configure(aspectingPlanet: "", secondPlanetImageImageName: "", firstSignTextText: "", secondSignTextText: "", secondPlanetTextText: synastry!.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!,by: Planet.jupiter.celestialObject)[indexPath.row].basicAspectString, firstPlanetTextText: "",firstAspectHeaderTextText: "",secondAspectHeaderTextText: " " )
...
//                    var transitSaturnAspects = [plutoSaturn]
            ...
            cell.configure(aspectingPlanet: "", secondPlanetImageImageName: "", firstSignTextText: "", secondSignTextText: "", secondPlanetTextText: synastry!.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!,by: Planet.saturn.celestialObject)[indexPath.row].basicAspectString, firstPlanetTextText: "",firstAspectHeaderTextText: "",secondAspectHeaderTextText: " " )
           ...
           return cell
            ...
            cell.configure(aspectingPlanet: "", secondPlanetImageImageName: "", firstSignTextText: "", secondSignTextText: "", secondPlanetTextText: synastry!.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!,by: Planet.uranus.celestialObject)[indexPath.row].basicAspectString, firstPlanetTextText: "",firstAspectHeaderTextText: "",secondAspectHeaderTextText: " " )
           ...
           return cell
            ...
            cell.configure(aspectingPlanet: "", secondPlanetImageImageName: "", firstSignTextText: "", secondSignTextText: "", secondPlanetTextText: synastry!.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!,by: Planet.neptune.celestialObject)[indexPath.row].basicAspectString, firstPlanetTextText: "",firstAspectHeaderTextText: "",secondAspectHeaderTextText: " " )
           ...
           return cell
            ...
            cell.configure(aspectingPlanet: "", secondPlanetImageImageName: "", firstSignTextText: "", secondSignTextText: "", secondPlanetTextText: synastry!.interchartAspectsFiltered(chart1: (chartCake?.natal.allBodies)!, chart2: (otherChart?.natal.allBodies)!,by: Planet.pluto.celestialObject)[indexPath.row].basicAspectString, firstPlanetTextText: "",firstAspectHeaderTextText: "",secondAspectHeaderTextText: " " )
