...
class NestedMPAspectsViewController: UIViewController {
...
//        ascTableView.delegate = self
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        setTableViewContentSize(for: .sun, tableView: sunTableView)
         setTableViewContentSize(for: .moon, tableView: moonTableView)
        setTableViewContentSize(for: .mercury, tableView: mercuryTableView)
        setTableViewContentSize(for: .venus, tableView: venusTableView)
        setTableViewContentSize(for: .mars, tableView: marsTableView)
        setTableViewContentSize(for: .jupiter, tableView: jupiterTableView)
        setTableViewContentSize(for: .saturn, tableView: saturnTableView)
        setTableViewContentSize(for: .uranus, tableView: uranusTableView)
        setTableViewContentSize(for: .neptune, tableView: neptuneTableView)
        setTableViewContentSize(for: .pluto, tableView: plutoTableView)
...
extension NestedMPAspectsViewController: UITableViewDataSource, UITableViewDelegate {
