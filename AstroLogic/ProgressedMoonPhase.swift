...
class ProgressedMoonPhaseViewController: UIViewController {
    ...
    func moonSpeedDescription(speed: Double?) -> String {
        var moonSpeed = chartCake?.major.moon.speedLongitude
    ...
    func moonDeclinationDescription(declination: Double?) -> String {
        var moonDeclination = chartCake?.major.moon.declination
...
var lunarPhases = chartCake?.lunarPhase(for: chartCake!.major).rawValue
        ...
        speedLabel.text = moonSpeedDescription(speed: chartCake?.major.moon.speedLongitude)
        declinationLabel.text = moonDeclinationDescription(declination: chartCake?.major.moon.declination)
    }
