...
class RelationshipBirthChartView: UIView {
    var planetPositions: [CelestialObject: CGFloat] = [:]
    var chartCake: ChartCake
    var otherChartCake: ChartCake
    
    init(frame: CGRect, chartCake: ChartCake, otherChartCake: ChartCake) {
        self.chartCake = chartCake
        self.otherChartCake = otherChartCake
