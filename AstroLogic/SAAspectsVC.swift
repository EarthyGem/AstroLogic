...
class SAAspectsPlanetsViewController  : UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        sunTableView.contentSize.height = CGFloat(chartCake!.solarArcAspectsFiltered(by: Planet.sun.celestialObject).count * 90)
        //        sunTableView.contentSize = CGSize(width: view.frame.width, height: numbers)
        moonTableView.contentSize.height = CGFloat(chartCake!.solarArcAspectsFiltered(by: Planet.moon.celestialObject).count * 90)
        mercuryTableView.contentSize.height = CGFloat(chartCake!.solarArcAspectsFiltered(by: Planet.mercury.celestialObject).count * 90)
        venusTableView.contentSize.height = CGFloat(chartCake!.solarArcAspectsFiltered(by: Planet.venus.celestialObject).count * 90)
        marsTableView.contentSize.height = CGFloat(chartCake!.solarArcAspectsFiltered(by: Planet.mars.celestialObject).count * 90)
        jupiterTableView.contentSize.height = CGFloat(chartCake!.solarArcAspectsFiltered(by: Planet.jupiter.celestialObject).count * 90)
        saturnTableView.contentSize.height = CGFloat(chartCake!.solarArcAspectsFiltered(by: Planet.saturn.celestialObject).count * 90)
        uranusTableView.contentSize.height = CGFloat(chartCake!.solarArcAspectsFiltered(by: Planet.uranus.celestialObject).count * 90)
        neptuneTableView.contentSize.height = CGFloat(chartCake!.solarArcAspectsFiltered(by: Planet.neptune.celestialObject).count * 90)
        plutoTableView.contentSize.height = CGFloat(chartCake!.solarArcAspectsFiltered(by: Planet.pluto.celestialObject).count * 90)
...
extension SAAspectsPlanetsViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return chartCake!.solarArcAspectsFiltered(by: planet.celestialObject).count
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let aspectString = chartCake!.solarArcAspectsFiltered(by: planet.celestialObject)[indexPath.row].basicAspectString
