...
class SolarArcBiWheelChartView: UIView {
    var chart: Chart!
    var chartCake: ChartCake!
    var majorProgressedChart: ChartCake!
...
private func drawTransitPlanetSymbols(context: CGContext) {
    ...
    func getDegree(chartCake: ChartCake) -> [(planet: CelestialObject, degree: String)]  {
        let planetDegree: [(planet: CelestialObject, degree: String)] = [
            (.planet(.sun), "\(Int(chartCake.icing.sun.degree))°"),
            (.planet(.moon), "\(Int(chartCake.icing.moon.degree))°"),
            (.planet(.mercury), "\(Int(chartCake.icing.mercury.degree))°"),
            (.planet(.venus), "\(Int(chartCake.icing.venus.degree))°"),
            (.planet(.mars), "\(Int(chartCake.icing.mars.degree))°"),
            (.planet(.jupiter), "\(Int(chartCake.icing.jupiter.degree))°"),
            (.planet(.saturn), "\(Int(chartCake.icing.saturn.degree))°"),
            (.planet(.uranus), "\(Int(chartCake.icing.uranus.degree))°"),
            (.planet(.neptune), "\(Int(chartCake.icing.neptune.degree))°"),
            (.planet(.pluto), "\(Int(chartCake.icing.pluto.degree))°"),
            (.lunarNode(.meanSouthNode), "\(Int(chartCake.icing.southNode.degree))°")
...
return planetDegree
    ...
    let planetSignSymbols: [(planet: CelestialObject, imageName: String)] = [
        (.planet(.sun), chartCake!.icing.sun.sign.keyName),
        (.planet(.moon), chartCake!.icing.moon.sign.keyName),
        (.planet(.mercury), chartCake!.icing.mercury.sign.keyName),
        (.planet(.venus), chartCake!.icing.venus.sign.keyName),
        (.planet(.mars), chartCake!.icing.mars.sign.keyName),
        (.planet(.jupiter), chartCake!.icing.jupiter.sign.keyName),
        (.planet(.saturn), chartCake!.icing.saturn.sign.keyName),
        (.planet(.uranus), chartCake!.icing.uranus.sign.keyName),
        (.planet(.neptune), chartCake!.icing.neptune.sign.keyName),
        (.planet(.pluto), chartCake!.icing.pluto.sign.keyName),
        (.lunarNode(.meanSouthNode), chartCake!.icing.southNode.sign.keyName)

    ]


    let planetMinute: [(planet: CelestialObject, minute: String)] = [
        (.planet(.sun), "\(Int(chartCake!.icing.sun.minute))°"),
        (.planet(.moon), "\(Int(chartCake!.icing.moon.minute))°"),
        (.planet(.mercury), "\(Int(chartCake!.icing.mercury.minute))°"),
        (.planet(.venus), "\(Int(chartCake!.icing.venus.minute))°"),
        (.planet(.mars), "\(Int(chartCake!.icing.mars.minute))°"),
        (.planet(.jupiter), "\(Int(chartCake!.icing.jupiter.minute))°"),
        (.planet(.saturn), "\(Int(chartCake!.icing.saturn.minute))°"),
        (.planet(.uranus), "\(Int(chartCake!.icing.uranus.minute))°"),
        (.planet(.neptune), "\(Int(chartCake!.icing.neptune.minute))°"),
        (.planet(.pluto), "\(Int(chartCake!.icing.pluto.minute))°"),
        (.lunarNode(.meanSouthNode), "\(Int(chartCake!.icing.southNode.minute))°")
...
func updateTransitPlanetPositions(newTransitPositions: [CelestialObject: CGFloat]) {
    ...
    func updateTransitChart() {
        ...
        let planetPositions: [CelestialObject: CGFloat] = [
            .planet(.sun): chartCake.icing.rickysBodies[0].value - ascendantOffset,
            .planet(.moon): chartCake.icing.rickysBodies[1].value - ascendantOffset,
            .planet(.mercury): chartCake.icing.rickysBodies[2].value - ascendantOffset,
            .planet(.venus): chartCake.icing.rickysBodies[3].value - ascendantOffset,
            .planet(.mars): chartCake.icing.rickysBodies[4].value - ascendantOffset,
            .planet(.jupiter): chartCake.icing.rickysBodies[5].value - ascendantOffset,
            .planet(.saturn): chartCake.icing.rickysBodies[6].value - ascendantOffset,
            .planet(.uranus): chartCake.icing.rickysBodies[7].value - ascendantOffset,
            .planet(.neptune): chartCake.icing.rickysBodies[8].value - ascendantOffset,
            .planet(.pluto): chartCake.icing.rickysBodies[9].value - ascendantOffset,
            .lunarNode(.meanSouthNode): chartCake.icing.rickysBodies[10].value - ascendantOffset
        ]
...
private func getTransitPlanets() -> [CGFloat] {
    let sunPosition = chartCake!.icing.sun.value
    let moonPosition = chartCake!.icing.moon.value
    let mercuryPosition = chartCake!.icing.mercury.value
    let venusPosition = chartCake!.icing.venus.value
    let marsPosition = chartCake!.icing.mars.value
    let jupiterPosition = chartCake!.icing.jupiter.value
    let saturnPosition = chartCake!.icing.saturn.value
    let uranusPosition = chartCake!.icing.uranus.value
    let neptunePosition = chartCake!.icing.neptune.value
    let plutoPosition = chartCake!.icing.pluto.value
//        let northNodePosition = chart!.northNode.value
    let southNodePosition = chartCake!.icing.southNode.value
