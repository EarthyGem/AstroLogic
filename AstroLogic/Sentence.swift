...
func generateAstroSentence(strongestPlanet: String,
    ...
    let signArrays: [String: [String]] = ["Aries": ["Energetic", "Confident", "Daring"],
                                          ...
                                          "Capricorn": ["Achiever", "Climber", "Grinder", "Boss", "Chief", "Consigliere", "Control Freak",  "Stoic", "Discipliner", "Executive", "Hermit", "Judge", "Manager", "Manifester", "Master",  "Old Soul", "Parent", "Planner", "Pragmatist", "Realist", "Rule-Follower", "Stoic", "Strategist", "Workaholic", "Taskmaster", "Traditionalist",  "Judge", "Authority"],
                                          "Aquarius": [
                                            "Anarchist",
                                            "Astrologer",
