...
class SimpleMajorAspectsViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        func setTableContentSize(for celestialBody: String, on tableView: UITableView) {
            ...
            let aspectCount = chartCake.constructSimpleMajorAspectDictionary()[celestialBody]?.count ?? 0
...
extension SimpleMajorAspectsViewController: UITableViewDataSource, UITableViewDelegate {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        guard let planet = tableViewToPlanetMap[tableView],
              let majorAspects = chartCake?.constructSimpleMajorAspectDictionary()[planet.celestialObject.keyName] else {
            return 0
        }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let planet = tableViewToPlanetMap[tableView],
           let majorAspects = chartCake?.constructSimpleMajorAspectDictionary()[planet.celestialObject.keyName] {
