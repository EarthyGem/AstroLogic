...
class SimpleMinorAspectViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        func setTableContentSize(for celestialBody: String, on tableView: UITableView) {
            ...
            let aspectCount = chartCake.constructSimpleMinorAspectDictionary()[celestialBody]?.count ?? 0
...
extension SimpleMinorAspectViewController: UITableViewDataSource, UITableViewDelegate {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        guard let planet = tableViewToPlanetMap[tableView],
              let majorAspects = chartCake?.constructSimpleMinorAspectDictionary()[planet.celestialObject.keyName] else {
            return 0
        }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let planet = tableViewToPlanetMap[tableView],
           let minorAspects = chartCake?.constructSimpleMinorAspectDictionary()[planet.celestialObject.keyName] {
    ...
    func navigateToTransitMatrixViewController(with minorAspect: AspectType) {
        ...
        transitMatrixVC.transitAspectsData = [
            minorAspect: chartCake!.filterSimpleTransits(for: minorAspect)
        ]
