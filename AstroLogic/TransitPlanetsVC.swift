...
//            minusYearButton.addTarget(self, action: #selector(minusYearButtonTapped), for: .touchUpInside)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.configure(signGlyphImageName: (chartCake.transits.rickysBodies[indexPath.row].body.keyName.lowercased()), planetImageImageName: (chartCake.transits.rickysBodies[indexPath.row].body.keyName.lowercased()), signTextText: (getTransitPositions(for: selectedDate!)[indexPath.row]), planetTextText: (chartCake.transits.rickysBodies[indexPath.row].body.transitName), headerTextText: "", capsuleText: chartCake.houseCusps.house(of: chartCake.transits.rickysBodies[safe: indexPath.row]!).houseString)
